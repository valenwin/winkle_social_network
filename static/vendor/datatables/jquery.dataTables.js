...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		 ...
		 *      oTable.$('tr:odd').style('backgroundColor', 'blue');
		 *    } );
		 *
		 *  @example
		 *    $(document).ready(function() {
		 ...
		 *      oTable.$('tr', {"search": "applied"}).style('backgroundColor', 'blue');
		 *      oTable.fnFilter('');
		 *    } );
		 */
	 ...
	 *  @param {string} value to style-ify
	 *  @returns {string} value with style unit
	 *  @memberof DataTable#oApi
	 */
